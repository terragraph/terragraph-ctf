...
class Qos_Nw(TestX86TGIgn, TestTgQos):
    TEST_NAME = "Qos_NW"
    DESCRIPTION = "Puma QoS Network Test"
    ...
    def get_test_steps(self) -> List[Dict]:
        ...
        steps.extend(
            [
                {
                    "name": "Print the node config on the 6 node",
                ...
                {
                    "name": "Print the node config on the 5 node",
                    "function": self.show_current_node_config,
                    "function_args": ([5],),
                    "success_msg": "node config printed successfully",
                },
                {
                    "name": "Print the policer info on CN1 (3C) node",
                    "function": self.print_policerinfo,
                    "function_args": ([3],),
                    "success_msg": "policer info printed successfully",
                },
                {
                    "name": "Print the policer info on CN2 (3E) node",
                    "function": self.print_policerinfo,
                    "function_args": ([5],),
                    "success_msg": "policer info printed successfully",
                },
